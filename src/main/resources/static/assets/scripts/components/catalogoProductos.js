...
function confirmaActivar(id) {
    swal({
        title: "¿Desea continuar?",
        text: "El producto será reestablecido",
        icon: "warning",
        buttons: true,
        dangerMode: true,
    })
...
function confirmaActivarMica(id) {
    swal({
        title: "¿Desea continuar?",
        text: "La mica será reestablecida",
        icon: "warning",
        buttons: true,
        dangerMode: true,
    })
...
function eliminaProducto(id, status) {

    var uri = ObtieneContex() + '/catalogo/elimina/producto/' + id + "/" + status;
